...
var prodServiceSpecs []string = []string{
	"statefulset|fg/dockie|10000|/v1/Backup|/v1/Restore|/var/data/single/<pod>-server-0",
	"statefulset|fg/tickie|10000|/v1/Backup|/v1/Restore|/var/data/single/<pod>-server-0",
	"statefulset|fg/ledgie|10000|/v1/Backup|/v1/Restore|/var/data/single/<pod>-server-0",
	"statefulset|fg/dubbie|10000|/v1/Backup|/v1/Restore|/var/data/single/<pod>-server-0",
	"statefulset|fg/keevie|10000|/v1/Backup|/v1/Restore|/var/data/single/<pod>-server-0",
	"statefulset|fg/permie|10000|/v1/Backup|/v1/Restore|/var/data/single/<pod>-server-0",
}
